                            ...
                            <ul class="slides">
                                <li data-thumb="images/si1.jpg" style="display: block">
                                    <div class="thumb-image">
                                        <img src="{{ asset('/images/'.$data->image) }}" data-imagezoom="true"
                ...
                <div class="col-lg-7 single-right-left simpleCart_shelfItem">
                    ...
                    <div class="product-single-w3l">
                        <p class="my-3">
                            ...
                            @if($data->type_id == 3)
                                <label>Thông tin sản phẩm</label></p>
                        <ul>
                            <p class="mb-1" style="width:100px;">
                                {{$data->description}}
                            </p>
                    ...
                    @else
                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                            <a href="#" data-url="{{route('home.addToCart',['id'=>$data->id])}}"
                               class="add-to-cart btn btn-primary">Thêm giỏ hàng</a>
                        </div>
                    @endif
                </div>
            </div>
